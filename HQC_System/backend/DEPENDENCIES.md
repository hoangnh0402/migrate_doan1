...
Tài liệu này liệt kê tất cả các thư viện và gói phần mềm được sử dụng trong dự án HQC System Backend.
...
Dự án HQC System Backend được phát hành theo giấy phép **GNU General Public License v3.0 (GPL-3.0)**.
