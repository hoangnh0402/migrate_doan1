...
Thư viện xây dựng và xử lý NGSI-LD entities theo chuẩn ETSI cho nền tảng HQC System Smart City.

## Cài đặt

```bash
npm install @pka_opendynamics_2025/hqc-system-ngsi-ld
```
...
```typescript
import { createEntityId, parseEntityId, isValidEntityId } from '@pka_opendynamics_2025/hqc-system-ngsi-ld';
...
```typescript
import { createProperty, createGeoProperty, createRelationship } from '@pka_opendynamics_2025/hqc-system-ngsi-ld';
...
import {
  ...
  createCivicIssue,
} from '@pka_opendynamics_2025/hqc-system-ngsi-ld';
...
```typescript
import { validateEntity } from '@pka_opendynamics_2025/hqc-system-ngsi-ld';
...
```typescript
import { buildQueryString } from '@pka_opendynamics_2025/hqc-system-ngsi-ld';
...
- `HQC_SYSTEM_CONTEXT` - HQC System Context URL
