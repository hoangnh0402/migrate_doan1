...
base_dir = r"c:\Users\hoang.nguyenhuy3\migrate_doan1\HQC System\backend-spring"
...
for mod, paths in modules.items():
    ...
    pkg_base = os.path.join(mod_dir, "src", "main", "java", "com", "HQC System", mod.replace("-domain", ""))
