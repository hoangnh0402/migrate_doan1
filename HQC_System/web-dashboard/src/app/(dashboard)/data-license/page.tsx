...
export default function DataLicensePage() {
  ...
  const copyAttribution = () => {
    const attribution = `Data from HQC System Smart City Platform (https://hqcsystem.vn) is licensed under CC BY 4.0`;
  ...
  const licenses = [
    ...
    },
    {
      ...
      icon: FileText,
      color: 'bg-blue-500',
      description: 'Toàn bộ mã nguồn của nền tảng HQC System',
  ...
  const ccByFeatures = [
    ...
    },
    {
      ...
      description: 'Phải ghi nhận nguồn gốc dữ liệu từ HQC System một cách phù hợp',
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-green-50/30 to-white dark:from-gray-950 dark:via-green-950/10 dark:to-gray-950">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
              HQC System cam kết cung cấp dữ liệu mở cho cộng đồng. Tất cả dữ liệu công khai được xuất bản 
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
            ...
            <div className="relative">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-4">
                <code className="text-sm text-white/90 break-all">
                  Data from HQC System Smart City Platform (https://hqcsystem.vn) is licensed under CC BY 4.0
                </code>
              </div>
        ...
        <section className="text-center">
          ...
          <a
            href="mailto:license@hqcsystem.vn"
            className="inline-flex items-center gap-2 text-green-600 hover:text-green-700 font-medium"
          >
            license@hqcsystem.vn
            <ExternalLink className="h-4 w-4" />
          </a>
        </section>
      </div>
