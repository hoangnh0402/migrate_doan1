...
Tài liệu này liệt kê tất cả các thư viện và gói phần mềm được sử dụng trong dự án HQC System Web Dashboard.
...
Dự án HQC System Web Dashboard được phát hành theo giấy phép **GNU General Public License v3.0 (GPL-3.0)**.

## External Services

Dashboard kết nối với HQC System Backend API để lấy dữ liệu. Không có external service nào được gọi trực tiếp từ frontend.
